...
??? abstract "On-Box Programmability and Automation"
    ...
    - [EEM Configuration - NX-OS Configuration Guide](https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/system-management/b-cisco-nexus-9000-series-nx-os-system-management-configuration-guide-93x/b-cisco-nexus-9000-series-nx-os-system-management-configuration-guide-93x_chapter_0100010.html "EEM Configuration - NX-OS Configuration Guide"){target=_blank}
    - [EEM Examples - NX-OS Configuration Guide](https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/system-management/b-cisco-nexus-9000-series-nx-os-system-management-configuration-guide-93x/b-cisco-nexus-9000-series-nx-os-system-management-configuration-guide-93x_appendix_011101.html "EEM Examples - NX-OS Configuration Guide"){target=_blank}
...
??? abstract "NX-API"
    - [NX-OS DME Model Reference](https://developer.cisco.com/site/nxapi-dme-model-reference-api/?version=9.3(5) "NX-OS DME Model Reference"){target=_blank}
